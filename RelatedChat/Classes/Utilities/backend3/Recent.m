...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	object[FRECENT_OBJECTID] = [Checksum md5HashOfString:temp];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	object[FRECENT_USERID] = userId;
	object[FRECENT_GROUPID] = groupId;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	object[FRECENT_INITIALS] = initials;
	object[FRECENT_PICTURE] = (picture != nil) ? picture : @"";
	object[FRECENT_DESCRIPTION] = description;
	object[FRECENT_MEMBERS] = members;
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	object[FRECENT_MUTEDUNTIL] = @0;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	object[FRECENT_ISARCHIVED] = @NO;
	object[FRECENT_ISDELETED] = @NO;
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
#pragma mark - Mute/Unmute methods

//-------------------------------------------------------------------------------------------------------------------------------------------------
+ (void)muteItem:(NSString *)objectId until:(long long)timestamp
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
+ (void)unmuteItem:(NSString *)objectId
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
}
