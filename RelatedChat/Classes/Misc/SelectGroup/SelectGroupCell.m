...
@implementation SelectGroupCell
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (path == nil)
	{
		imageGroup.image = [UIImage imageNamed:@"selectgroup_blank"];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[DownloadManager image:dbgroup.picture completion:^(NSString *path, NSError *error, BOOL network)
	{
		...
		{
			SelectGroupCell *cell = [tableView cellForRowAtIndexPath:indexPath];
