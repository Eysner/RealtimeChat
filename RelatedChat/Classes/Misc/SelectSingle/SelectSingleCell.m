...
@implementation SelectSingleCell
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (path == nil)
	{
		imageUser.image = [UIImage imageNamed:@"selectsingle_blank"];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[DownloadManager image:dbuser.picture completion:^(NSString *path, NSError *error, BOOL network)
	{
		...
		{
			SelectSingleCell *cell = [tableView cellForRowAtIndexPath:indexPath];
