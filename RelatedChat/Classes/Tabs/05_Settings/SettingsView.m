...
@synthesize cellBlocked, cellArchive, cellCache, cellMedia, cellAutoSave, cellWallpapers;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ((indexPath.section == 2) && (indexPath.row == 4)) return cellAutoSave;
	if ((indexPath.section == 2) && (indexPath.row == 5)) return cellWallpapers;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ((indexPath.section == 2) && (indexPath.row == 4)) [self actionAutoSave];
	if ((indexPath.section == 2) && (indexPath.row == 5)) [self actionWallpapers];
