...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	fieldPhone.text = user[FUSER_PHONE];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	BOOL phoneLogin = [user[FUSER_LOGINMETHOD] isEqualToString:LOGIN_PHONE];
	fieldPhone.userInteractionEnabled = (phoneLogin == NO);
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ([fieldPhone.text length] == 0)		{	[ProgressHUD showError:@"Phone number must be set."];	return; }
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[self saveUser];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[self dismissViewControllerAnimated:YES completion:nil];
