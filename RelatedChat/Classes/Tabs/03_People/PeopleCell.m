...
//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)bindData:(DBContact *)dbcontact
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	labelName1.text = dbcontact.fullname;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	labelName2.text = nil;
	...
	labelInitials.text = [dbcontact initials];
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)bindData:(DBContact *)dbcontact dbuser:(DBUser *)dbuser
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	labelName1.text = nil;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	labelName2.text = dbcontact.fullname;
